...
const faqs = [
  ...
  ['¿Qué madera utilizan?', 'Trabajamos con madera seleccionada por su resistencia, confiabilidad y durabilidad.'],
  ...
  return (
    <main>
      ...
      <section id="inicio" className="hero section-shell">
        ...
        <div className="hero-art" aria-label="Pallets de madera en depósito" role="img"><div className="hero-image" /><div className="hero-stamp"><strong>Desde el 2000</strong><span>+20 años de experiencia</span></div><div className="hero-side-note">PALLETS<br /><span>BUENOS AIRES · ARG</span></div></div>
      </section>

      <section className="trust-strip"><div className="section-shell trust-grid"><p className="trust-lead">Una base confiable para<br /><strong>operaciones que no paran.</strong></p><div className="trust-stat"><strong>+20</strong><span>años de experiencia</span></div><div className="trust-stat"><strong>100%</strong><span>asesoría personalizada</span></div><div className="trust-stat"><strong>AR</strong><span>entregas en todo el país</span></div></div></section>
